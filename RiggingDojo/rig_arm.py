...
# create ik arm
ikjnt_list = [['L_Ik_shoulder_jnt', [0.0, 0, 0.0]], ['L_Ik_elbow_jnt', [2.0, 0, -1.0]], ['L_Ik_wrist_jnt', [4.0, 0, 0.0]], ['L_Ik_hand_jnt', [5.0, 0, 0.0]]]
fkjnt_list = [['L_Fk_shoulder_jnt', [0.0, 0, 0.0]], ['L_Fk_elbow_jnt', [2.0, 0, -1.0]], ['L_Fk_wrist_jnt', [4.0, 0, 0.0]], ['L_Fk_hand_jnt', [5.0, 0, 0.0]]]
jnt_list = [['L_shoulder_jnt', [0.0, 0, 0.0]], ['L_elbow_jnt', [2.0, 0, -1.0]], ['L_wrist_jnt', [4.0, 0, 0.0]], ['L_hand_jnt', [5.0, 0, 0.0]]]
...
#create bind joints
createJoint(jnt_list)
# orient joints
cmds.joint('L_shoulder_jnt', e=True, oj='xyz', sao='yup', ch=True, zso=True)
#deselect joints
cmds.select(d=True)

armCtl = ('L_Fk_shoulder_jnt', 'L_Fk_elbow_jnt', 'L_Fk_wrist_jnt', 'L_Ik_shoulder_jnt', 'L_Ik_elbow_jnt', 'L_Ik_wrist_jnt')

shldrJntPos = cmds.xform('L_Fk_shoulder_jnt', q=True, ro=True, ws=True)
elbowJntPos = cmds.xform('L_Fk_shoulder_jnt', q=True, ro=True, ws=True)
wristJntPos = cmds.xform('L_Fk_shoulder_jnt', q=True, ro=True, ws=True)




#create fk controls
mylist = ['L_Fk_shoulder_jnt', 'L_Fk_elbow_jnt', 'L_Fk_wrist_jnt', 'L_Fk_hand_jnt']
for f in mylist:
    #print f
    i = mylist.index(f)
   # print i
